...
class Options
{
	 ...
	 * PLAYER 1 CONTROLS
	 */
	public static var P1_NOTE_LEFT:Array<FlxKey> = [LEFT];
	public static var P1_NOTE_DOWN:Array<FlxKey> = [DOWN];
	public static var P1_NOTE_UP:Array<FlxKey> = [UP];
	public static var P1_NOTE_RIGHT:Array<FlxKey> = [RIGHT];
	public static var P1_LEFT:Array<FlxKey> = [LEFT];
	public static var P1_DOWN:Array<FlxKey> = [DOWN];
	public static var P1_UP:Array<FlxKey> = [UP];
	public static var P1_RIGHT:Array<FlxKey> = [RIGHT];
	 ...
	 */
	public static var P2_NOTE_LEFT:Array<FlxKey> = [A];
	public static var P2_NOTE_DOWN:Array<FlxKey> = [S];
	public static var P2_NOTE_UP:Array<FlxKey> = [W];
	public static var P2_NOTE_RIGHT:Array<FlxKey> = [D];
	public static var P2_LEFT:Array<FlxKey> = [A];
	public static var P2_DOWN:Array<FlxKey> = [S];
	public static var P2_UP:Array<FlxKey> = [W];
	public static var P2_RIGHT:Array<FlxKey> = [D];
	...
	public static function load() {
		...
		__save.bind("options", #if sys 'soy_asterisk/vs_Soi_Mod' #else 'FNF_vs_Soi' #end);
		__load();
