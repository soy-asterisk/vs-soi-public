...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var versionShit:FunkinText = new FunkinText(5, FlxG.height - 2, 0, 'Codename Engine v${Application.current.meta.get('version')} (Alpha)\nvs Soi v${Main.vsSoiVersion}\n');
		#if MOD_SUPPORT
		versionShit.text += '[TAB] Open Mods menu\n';
		#end
