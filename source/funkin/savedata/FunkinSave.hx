...
class FunkinSave {
	...
	public static var daybreakClear:Bool = false;
	...
	public static function init() {
		...
		save = new FlxSave();
		save.bind('save-default', #if sys 'soy_asterisk/vs_Soi_Mod' #else 'FNF_vs_Soi' #end);
		load();
	...
	public static inline function resetHighscore(){
		highscores.clear();
		flush();
	}
